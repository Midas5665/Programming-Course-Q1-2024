...
public class UniversalAutomatonTest {
   ...
   @Test
    public void testNextGen() {
        ...
        boolean[] initGen3 = {false, false, false, false, true,
            false, false, false, false, false, false, false};
        boolean[] expectedOutput3 = { false, false, false, true, false,
            true, false, false, false, false, false, false};
        assertArrayEquals(expectedOutput3, new 
            UniversalAutomaton().nextGen(ruleSequence3, initGen3));
        ...
        assertArrayEquals(expectedOutput4, new UniversalAutomaton().nextGen(ruleSequence4, initGen4));
    }
